...
Содержание комплекта заданий формируется вариативно системой.
...
Интерфейс выполнения типового задания из комплекта заданий:
...
При выполнении домашнего задания не позднее, чем за 2 недели ДО окончания семестра, обучающийся получает 2 дополнительных балла.
