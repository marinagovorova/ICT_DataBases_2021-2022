...
По итогам выполнения работы студент защищает отчет. При представлении реалзиованной базы данных необходимо устно обосновать состояние реализованной БД в соответствии с нормальными формами. 
