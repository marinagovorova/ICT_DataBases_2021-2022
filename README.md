...
#### Защита лабораторной работы №2
 По итогам выполнения работы студент представляет отчет. На GIT должен быть загружен pdf-файл отчета по работе в соответствии с требованиями, изложенными в файле работы. При представлении реализованнго задания проводится устное собеседование по отчету.
